...
<script>
// SIMPLE PASSWORD PROTECTION - WORKING
(function() {
    // Clear any existing auth for testing
    ...
    if (userPass !== correctPass) {
        document.body.innerHTML = "<div style='text-align:center; padding:100px; background:#0a0e1a; color:#ef4444; font-family:Arial; min-height:100vh'><h1>🔒 Access Denied</h1><p style='color:#64748b'>Contact administrator</p></div>";
    } else {
