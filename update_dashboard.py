...
(function() {
    ...
    overlay.innerHTML = `
        <div style="text-align: center; padding: 40px; max-width: 450px; width: 90%;">
            <div style="margin-bottom: 30px;">
                <div style="font-size: 48px; margin-bottom: 10px;">📊</div>
                <h1 style="color: #3b82f6; font-size: 24px; margin-bottom: 8px; font-family: 'Syne', sans-serif;">QHSE Dashboard</h1>
                <p style="color: #64748b; font-size: 14px;">PDO Riyah 1 & 2 Wind IPP</p>
            </div>
            ...
            <div style="background: #111827; border-radius: 16px; padding: 32px; border: 1px solid rgba(255,255,255,0.1);">
                ...
                <div style="font-size: 12px; color: #4a5568; border-top: 1px solid #1a2235; padding-top: 20px;">
